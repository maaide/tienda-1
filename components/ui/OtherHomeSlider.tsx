...
export const OtherHomeSlider = () => {
  ...
  return (
    ...
    >
      <SwiperSlide>
        <div className={`${imageView} h-400 transition-opacity duration-200 flex p-4 bg-cover bg-[url(https://res.cloudinary.com/blasspod/image/upload/v1680628242/blaspod/pexels-xue-guangjian-1687845_ocry6n.jpg)] xl:h-600 2xl:h-700`}>
          <div className='w-1280 m-auto'>
            <h1 className={`${textView} text-[25px] transition-opacity duration-150 text-white font-bold mb-2 md:text-[32px]`}>ENCUÉNTRA OFERTAS DE HASTA UN 40% DE DESCUENTO</h1>
            <p className={`${textView} text-white transition-opacity duration-150 text-lg mb-4`}>Aprovecha nuestras increibles ofertas solo por tiempo limitado.</p>
