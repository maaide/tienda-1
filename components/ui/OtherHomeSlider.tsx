    ...
    >
      <SwiperSlide>
        <div className={`h-400 flex xl:h-600 2xl:h-700`}>
          ...
          <img className={`object-cover h-full w-full absolute -z-10 ${imageView} transition-opacity duration-200`} src='https://res.cloudinary.com/blasspod/image/upload/v1686583650/blaspod/banner_c2pec5.jpg' />
        </div>
      </SwiperSlide>
      <SwiperSlide>
        <div className='h-400 flex xl:h-600 2xl:h-700'>
